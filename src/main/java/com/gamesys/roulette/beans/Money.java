...
public class Money {
    ...
    public static Money pounds(double amount) {
        return new Money(amount, Currency.getInstance(Locale.UK));
    }
    ...
    private void assertSameCurrencyAs(Money arg) {
        Assert.isTrue(currency == arg.currency, "money math mismatch");
    }
    ...
    public Money[] allocate(int targets) {
        ...
        for (int i = remainder; i < targets; i++) results[i] = lowResult;
        return results;
    }
